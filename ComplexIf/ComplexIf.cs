...
public class ComplexIf
{
    ...
    private static bool IsPremium(Customer customer)
    {
        return customer.HasLoyaltyCard && customer.TotalTurnover > PremiumTotalTurnover
                                       && customer.LastQuarterTurnover > PremiumQuarterTurnover;
    }
